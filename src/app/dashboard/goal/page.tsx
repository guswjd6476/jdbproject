...
export default function GoalCalculatorTable() {
    ...
    const defaultWeeklyPercentages = useMemo(
        () => ({
            week1: { 발: 0.6, 찾: 0, 합: 0, 섭: 0.0, 복: 0.0, 예정: 0.0 },
            week2: { 발: 0.4, 찾: 0.5, 합: 0, 섭: 0, 복: 0.0, 예정: 0.0 },
            week3: { 발: 0.0, 찾: 0.5, 합: 0.5, 섭: 0, 복: 0.0, 예정: 0.0 },
            week4: { 발: 0.0, 찾: 0.0, 합: 0.5, 섭: 0, 복: 0.0, 예정: 0.0 },
            week5: { 발: 0.0, 찾: 0.0, 합: 0, 섭: 1, 복: 0.0, 예정: 0.0 },
